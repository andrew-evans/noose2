...
function krnOnCPUClockPulse() 
{
	...
	var CPUString = "";
	//This is probably bad programming, but it's easy to read.
	CPUString += "PC    \t-\t" + _CPU.PC + "\n";
	CPUString += "Acc   \t-\t" + _CPU.Acc + "\n";
	CPUString += "X Reg \t-\t" + _CPU.Xreg + "\n";
	CPUString += "Y Reg \t-\t" + _CPU.Yreg + "\n";
	CPUString += "Z Flag\t-\t" + _CPU.Zflag + "\n";
